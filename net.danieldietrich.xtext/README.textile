...
* src
  contains the manually written source
* src-gen
  contains the antlr generated files
* test
  contains just a simple test/example
...
See: "Antlr download page":http://www.antlr.org/download.html
