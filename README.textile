...
**Eclipse Update site:** "http://danieldietrich.net/protectedregions/updates/releases/2.0.0":http://danieldietrich.net/protectedregions/updates/releases/2.0.0
...
For eclipse base code generators add these lines to the XxxRuntimeModule.java:
...
That's it. Use your generator as usual.

h2. Additions

_(Documentation follows soon...)_
...
Xtext PRS can be installed from the following update site:
* Update site for releases "http://danieldietrich.net/protectedregions/updates/releases/1.0.1":http://danieldietrich.net/protectedregions/updates/releases/1.0.1
