THIS PROJECT IS DISCONTINUED. IF THE GENERATE SOURCE OF YOUR LANGUAGE SUPPORTS INHERITANCE PLEASE CONSIDER TO USE THE "GENERATION GAP PATTERN":https://en.wikipedia.org/wiki/Generation_gap_(pattern).
